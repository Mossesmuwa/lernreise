    ...
    <div className="min-h-screen md:flex bg-paper">
      ...
      <aside className="hidden md:flex md:w-72 md:flex-col md:bg-[#e8eeea] md:px-5 md:py-7 md:sticky md:top-0 md:h-screen">
        <div className="px-3 mb-10">
          <p className="font-display text-pine-deep text-2xl leading-none">
            Lernreise
          </p>
        ...
        <p className="px-3 text-[10px] font-medium uppercase tracking-[0.16em] text-ink/35 mb-3">
          Workspace
        </p>
        ...
        <div className="border-t border-ink/10 pt-4 mt-6">
          <Link
            to="/settings"
            className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm text-ink/60 hover:bg-white/55 hover:text-ink"
          >
          ...
          {session && (
            <button
              onClick={signOut}
              className="w-full flex items-center gap-3 text-left rounded-xl px-3 py-2.5 text-sm text-ink/40 hover:bg-white/55 hover:text-ink"
            >
        ...
        <Link
          to="/settings"
          className="mt-5 flex items-center gap-3 rounded-2xl bg-white/55 border border-white/70 p-3 hover:bg-white/80"
        >
      ...
      <header className="md:hidden flex items-center justify-between px-4 py-4 border-b border-mist bg-card">
        <div>
          <p className="font-display text-pine-deep text-lg leading-none">
            Lernreise
          </p>
          <p className="text-[9px] uppercase tracking-[0.16em] text-ink/40 mt-1">
            Learning studio
          </p>
        </div>
